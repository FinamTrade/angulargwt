  ...
  private String generateController(TreeLogger logger, GeneratorContext context, String typeName,
    ...
    if (ngInject != null) {
      controllerName = ngInject.name();
         ...
         * var wrapScope = @com.google.gwt.todomvc.BodyScopeAdapter::new(Lelemental/json/JsonObject;)($scope);
         * self.@com.google.gwt.angular.client.AngularController::setScope(Lcom/google/gwt/angular/client/Scope;)(wrapScope);
         * self.@com.google.gwt.todomvc.client.TodoController::onInit(Lcom/google/gwt/angular/client/TodoScope;Lcom/google/gwt/dom/client/Element;)(wrapScope, $element);
         * $scope.doSomething = $entry(function() {
         *   return self.@com.google.gwt.todomvc.client.TodoController::doSomething()();
         * });
         * });
